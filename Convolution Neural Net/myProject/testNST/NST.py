...
# this function load image in a arrays
#image are load for model compitable
...
style = load_image('forest.jpg')

# Verify the shapes
print(content.shape, style.shape)
#load a pre-trained VGG19 model for extracting the features.
...
#create a custom VGG model which will be composed of the specified layers.
